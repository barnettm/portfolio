...
// conditional not required if optional input on form element
$message['message'] = filter_var($_POST['message'], FILTER_SANITIZE_STRING);
if(empty($message['message'])){
    $output['success'] = false;
    $output['messages'][] = 'missing messages key';
};
...
$message['message'] = nl2br($message['message']); // creates a break when newline is detected (in email body)
